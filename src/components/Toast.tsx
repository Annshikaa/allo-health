...
export default function Toast({
  ...
  return (
    <motion.div
      ...
      className={`fixed top-6 left-1/2 z-50 flex items-center gap-3 px-5 py-3 rounded-xl border backdrop-blur-xl shadow-2xl max-w-sm w-full text-sm font-medium ${colors[type]}`}
...
export function ToastContainer({
  ...
  toasts: Array<{ id: string; message: string; type: "error" | "success" | "warning" }>;
